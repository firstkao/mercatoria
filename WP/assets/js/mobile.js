...
document.querySelectorAll('[data-hero-slider]').forEach(function (slider) {
  ...
  function openFilter() {
    ...
    filterBackdrop && filterBackdrop.classList.add('is-open');
  ...
  function closeFilter() {
    ...
    filterBackdrop && filterBackdrop.classList.remove('is-open');
    document.body.classList.remove('no-scroll');
  }

  filterOpen && filterOpen.addEventListener('click', openFilter);
  filterClose && filterClose.addEventListener('click', closeFilter);
  filterBackdrop && filterBackdrop.addEventListener('click', closeFilter);
  ...
  document.querySelectorAll('[data-price-slider]').forEach(function (form) {
    ...
    const section   = form.closest('.filter-section') || form.parentElement;
    const minLabel  = section.querySelector('[data-price-min-label]');
    const maxLabel  = section.querySelector('[data-price-max-label]');
